(function() {
    ...
    module.controller('createAliasCtrl',['CONFIG', '$scope', '$modalInstance', 'backend', 'safe', '$rootScope', '$filter', '$timeout', 'informer',
        function(CONFIG, $scope, $modalInstance, backend, safe, $rootScope, $filter, $timeout, informer){
            $scope.alias = {
                name : '',
