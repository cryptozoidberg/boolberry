...
services['poloniex'] = {
    ...
    fetch: function() {
        ...
        var data = $.parseJSON( secure_request_url("https://poloniex.com/public?command=returnTradeHistory&currencyPair=BTC_BBR", JSON.stringify(req_arams)));
