...
namespace currency
{
  ...
  /************************************************************************/
   ...
   public:
     ...
     bool core::handle_incoming_tx(const transaction & tx, tx_verification_context& tvc, bool keeped_by_block, const crypto::hash& tx_hash = null_hash);
     ...
     void set_config_folder(const std::string& folder);
