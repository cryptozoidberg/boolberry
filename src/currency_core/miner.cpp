...
namespace currency
{
  ...
  namespace
  {
    ...
    const command_line::arg_descriptor<std::string>   arg_set_donation_mode =  {"donation-vote", "Select one of two options for donations vote: \"true\"(to vote for donation) or \"false\"(to vote against)", "false", false};
  }
