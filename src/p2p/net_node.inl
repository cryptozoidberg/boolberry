...
namespace nodetool
{
  ...
  bool node_server<t_payload_net_handler>::init(const boost::program_options::variables_map& vm)
  {
    ...
    ADD_HARDCODED_SEED_NODE("207.154.237.82:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
    ADD_HARDCODED_SEED_NODE("207.154.240.198:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
    ADD_HARDCODED_SEED_NODE("207.154.255.10:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
    ADD_HARDCODED_SEED_NODE("207.154.228.141:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
#else
    ADD_HARDCODED_SEED_NODE("138.68.246.85:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
    ADD_HARDCODED_SEED_NODE("45.55.62.251:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
#endif
