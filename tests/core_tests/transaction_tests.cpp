...
bool test_transaction_generation_and_ring_signature()
{
  ...
  construct_miner_tx(0, 0, 0, 0, 10, 0, miner_acc1.get_keys().m_account_address, tx_mine_1);
  transaction tx_mine_2;
  construct_miner_tx(0, 0, 0, 0, 0, 0, miner_acc2.get_keys().m_account_address, tx_mine_2);
  transaction tx_mine_3;
  construct_miner_tx(0, 0, 0, 0, 0, 0, miner_acc3.get_keys().m_account_address, tx_mine_3);
  transaction tx_mine_4;
  construct_miner_tx(0, 0, 0, 0, 0, 0, miner_acc4.get_keys().m_account_address, tx_mine_4);
  transaction tx_mine_5;
  construct_miner_tx(0, 0, 0, 0, 0, 0, miner_acc5.get_keys().m_account_address, tx_mine_5);
  transaction tx_mine_6;
  construct_miner_tx(0, 0, 0, 0, 0, 0, miner_acc6.get_keys().m_account_address, tx_mine_6);
...
bool test_block_creation()
{
  ...
  block b;
  r = construct_miner_tx(90, epee::misc_utils::median(szs), 3553616528562147, 0, 33094, 10000000, adr, b.miner_tx);
  return r;
}
